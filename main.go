...
func (w Walking) Calories() float64 {
	...
	return (CaloriesWeightMultiplier*w.Weight + ((meanSpeedMSec*meanSpeedMSec)/(w.Height/CmInM))*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
